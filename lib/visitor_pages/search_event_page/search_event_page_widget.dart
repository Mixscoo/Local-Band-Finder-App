...
class SearchEventPageWidget extends StatefulWidget {
  ...
  static String routeName = 'SearchEventPage';
  static String routePath = '/searchEventPage';
    ...
    return StreamBuilder<List<PostEventsRecord>>(
      stream: queryPostEventsRecord(
        queryBuilder: (postEventsRecord) =>
            postEventsRecord.orderBy('created_time', descending: true),
      ),
      builder: (context, snapshot) {
        ...
        List<PostEventsRecord> searchEventPagePostEventsRecordList =
            snapshot.data!;
                              ...
                              () async {
                                safeSetState(() {
                                  _model.simpleSearchResults = TextSearch(
                                    searchEventPagePostEventsRecordList
                                        .map(
                                          (record) =>
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final listOfEvents =
                                searchEventPagePostEventsRecordList.toList();
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, listOfEventsIndex) {
                                final listOfEventsItem =
                                    listOfEvents[listOfEventsIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 1.0),
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.goNamed(
                                        VisitorViewEventDetailsWidget.routeName,
                                        queryParameters: {
                                          ...
                                          'eventID': serializeParam(
                                            listOfEventsItem.reference,
                                            ParamType.DocumentReference,
                                          ),
                                        }.withoutNulls,
                                        extra: <String, dynamic>{
                                          'eventdetails': listOfEventsItem,
                                        },
                                      );
                                    },
                                    child: Material(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.goNamed(
                                        ...
                                        extra: <String, dynamic>{
                                          'eventdetails': searchResultsItem,
                                        },
                                      );
                                    },
                                    child: Material(
