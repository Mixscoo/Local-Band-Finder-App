...
class _ChangePasswordPageWidgetState extends State<ChangePasswordPageWidget> {
  ...
  void initState() {
    ...
    _model.emailChangePasswordAccountTextController ??= TextEditingController();
    _model.emailChangePasswordAccountFocusNode ??= FocusNode();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      controller:
                          _model.emailChangePasswordAccountTextController,
                      focusNode: _model.emailChangePasswordAccountFocusNode,
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: (_model.emailChangePasswordAccountTextController
                                    .text ==
                                null ||
                            _model.emailChangePasswordAccountTextController
                                    .text ==
                        ...
                        ? null
                        : () async {
                            _model.changePasswordEmailExist =
                                await queryUsersRecordOnce(
                              queryBuilder: (usersRecord) => usersRecord.where(
                                'email',
                                isEqualTo: _model
                                    .emailChangePasswordAccountTextController
                                    .text,
                              ),
                              singleRecord: true,
                            ).then((s) => s.firstOrNull);
                            if (_model.changePasswordEmailExist?.email ==
                                _model.emailChangePasswordAccountTextController
                                    .text) {
                              if (_model
                                  .emailChangePasswordAccountTextController
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Email does not exist. Try different email.',
                                    style: TextStyle(
                                      color:
