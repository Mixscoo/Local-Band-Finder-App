...
class _ForgotPasswordPageWidgetState extends State<ForgotPasswordPageWidget> {
  ...
  void initState() {
    ...
    _model.emailForgotPasswordAccountTextController ??= TextEditingController();
    _model.emailForgotPasswordAccountFocusNode ??= FocusNode();
              ...
              children: [
                ...
                Form(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        controller:
                            _model.emailForgotPasswordAccountTextController,
                        focusNode: _model.emailForgotPasswordAccountFocusNode,
                ...
                Align(
                  ...
                  child: FFButtonWidget(
                    onPressed: (_model.emailForgotPasswordAccountTextController
                                    .text ==
                                null ||
                            _model.emailForgotPasswordAccountTextController
                                    .text ==
                        ...
                        ? null
                        : () async {
                            _model.forgotPasswordEmailExist =
                                await queryUsersRecordOnce(
                              queryBuilder: (usersRecord) => usersRecord.where(
                                'email',
                                isEqualTo: _model
                                    .emailForgotPasswordAccountTextController
                                    .text,
                              ),
                              singleRecord: true,
                            ).then((s) => s.firstOrNull);
                            if (_model.forgotPasswordEmailExist?.email ==
                                _model.emailForgotPasswordAccountTextController
                                    .text) {
                              if (_model
                                  .emailForgotPasswordAccountTextController
